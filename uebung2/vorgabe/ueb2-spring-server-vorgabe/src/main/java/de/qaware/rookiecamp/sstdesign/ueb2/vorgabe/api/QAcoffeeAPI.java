...
import de.qaware.rookiecamp.sstdesign.ueb2.vorgabe.api.model.Offering;
import de.qaware.rookiecamp.sstdesign.ueb2.vorgabe.api.model.Review;
...
public class QAcoffeeAPI {
    ...
    @RequestMapping(path = "/getOfferings", method = RequestMethod.GET)
    public ResponseEntity<Offering> getCoffee() {
        ...
        return new ResponseEntity<>(new Offering(), HttpStatus.OK);
    }
